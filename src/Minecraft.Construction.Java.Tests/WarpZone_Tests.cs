...
namespace Minecraft.Construction.Java.Tests
{
	...
	public class WarpZone_Tests
	{
		...
		public void Simple_Radius_10_with_1_Level()
		{
			...
			Assert.That(commandTexts[0], Is.EqualTo("/fill -10 2 -10 10 11 10 stone_bricks"));
			Assert.That(commandTexts[1], Is.EqualTo("/fill -10 2 -10 10 4 10 stone_bricks hollow"));
			Assert.That(commandTexts[2], Is.EqualTo("/fill -7 5 -7 7 8 7 air"));
			Assert.That(commandTexts[3], Is.EqualTo("/fill -10 9 -10 10 11 10 stone_bricks hollow"));
		}
		...
		public void Simple_Radius_10_with_2_Levels()
		{
			...
			Assert.That(commandTexts[0], Is.EqualTo("/fill -10 2 -10 10 18 10 stone_bricks"));
			Assert.That(commandTexts[1], Is.EqualTo("/fill -10 2 -10 10 4 10 stone_bricks hollow"));
			Assert.That(commandTexts[2], Is.EqualTo("/fill -7 5 -7 7 8 7 air"));
			Assert.That(commandTexts[3], Is.EqualTo("/fill -10 9 -10 10 11 10 stone_bricks hollow"));
			Assert.That(commandTexts[4], Is.EqualTo("/fill -7 12 -7 7 15 7 air"));
			Assert.That(commandTexts[5], Is.EqualTo("/fill -10 16 -10 10 18 10 stone_bricks hollow"));
		}
		...
		public void Simple_Radius_10_with_2_Levels_0_Interstitial()
		{
			...
			Assert.That(commandTexts[0], Is.EqualTo("/fill -10 2 -10 10 12 10 stone_bricks"));
		...
		public void Simple_Radius_10_with_2_Levels_2_Interstitial()
		{
			...
			// Assert
			Assert.That(commandTexts.Count, Is.EqualTo(6));
			Assert.That(commandTexts[0], Is.EqualTo("/fill -10 2 -10 10 21 10 stone_bricks"));
			Assert.That(commandTexts[1], Is.EqualTo("/fill -10 2 -10 10 5 10 stone_bricks hollow"));
			Assert.That(commandTexts[2], Is.EqualTo("/fill -7 6 -7 7 9 7 air"));
			Assert.That(commandTexts[3], Is.EqualTo("/fill -10 10 -10 10 13 10 stone_bricks hollow"));
			Assert.That(commandTexts[4], Is.EqualTo("/fill -7 14 -7 7 17 7 air"));
			Assert.That(commandTexts[5], Is.EqualTo("/fill -10 18 -10 10 21 10 stone_bricks hollow"));
		}
		...
		public void Simple_Radius_10_with_3_Levels_Pair_and_CutSides()
		{
			...
			Block stoneBrick = Block.Get(BlockID.StoneBricks.Normal);
			...
			Assert.That(normalCommandTexts[0], Is.EqualTo("/fill -12 1 -12 12 24 12 stone_bricks"));
			Assert.That(normalCommandTexts[1], Is.EqualTo("/fill -12 1 -12 12 3 12 stone_bricks hollow"));
			...
			Assert.That(normalCommandTexts[5], Is.EqualTo("/fill -12 8 -12 12 10 12 stone_bricks hollow"));
			...
			Assert.That(normalCommandTexts[9], Is.EqualTo("/fill -12 15 -12 12 17 12 stone_bricks hollow"));
			...
			Assert.That(normalCommandTexts[13], Is.EqualTo("/fill -12 22 -12 12 24 12 stone_bricks hollow"));
			...
			Assert.That(netherCommandTexts[1], Is.EqualTo("/fill -12 1 -12 12 3 12 polished_blackstone_bricks hollow"));
			...
			Assert.That(netherCommandTexts[5], Is.EqualTo("/fill -12 8 -12 12 10 12 polished_blackstone_bricks hollow"));
			...
			Assert.That(netherCommandTexts[9], Is.EqualTo("/fill -12 15 -12 12 17 12 polished_blackstone_bricks hollow"));
			...
			Assert.That(netherCommandTexts[13], Is.EqualTo("/fill -12 22 -12 12 24 12 polished_blackstone_bricks hollow"));
		...
		public void Multiple_Initial_Fill_Commands()
		{
			...
			Assert.That(commandTexts[0], Is.EqualTo("/fill -31 10 -31 31 17 31 stone_bricks"));
			Assert.That(commandTexts[1], Is.EqualTo("/fill -31 18 -31 31 25 31 stone_bricks"));
			Assert.That(commandTexts[2], Is.EqualTo("/fill -31 26 -31 31 33 31 stone_bricks"));
			Assert.That(commandTexts[3], Is.EqualTo("/fill -31 34 -31 31 41 31 stone_bricks"));
			Assert.That(commandTexts[4], Is.EqualTo("/fill -31 42 -31 31 47 31 stone_bricks"));
