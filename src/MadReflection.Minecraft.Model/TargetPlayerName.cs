...
namespace Minecraft.Model
{
	...
	public class TargetPlayerName : TargetPlayer, IEquatable<TargetPlayerName>
	{
		...
		public static bool InternalTryParse(string s, [NotNullWhen(true)] out TargetPlayerName? result, out Exception? exception, bool needException)
		{
			if (s is null)
			{
				result = null;
		...
		public override string GetArgumentText(Edition edition) => Name;
