namespace Minecraft.Model.Bedrock
{
	public static class BlockID
	{
		...
		public static class Tree
		{
			...
			public const string CrimsonPlanks = "crimson_planks";
		...
		public const string StainedGlassPane = "stained_glass_pane";
		public const string Concrete = "concrete";
		public const string ConcretePowder = "concrete_powder";
		public const string UndyedShulkerBox = "undyed_shulker_box";
