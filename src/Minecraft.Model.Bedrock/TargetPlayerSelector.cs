...
namespace Minecraft.Model.Bedrock
{
	...
	public class TargetPlayerSelector : TargetPlayer, IEquatable<TargetPlayerSelector>
	{
		...
		public static readonly TargetPlayerSelector PlayerAgent = new TargetPlayerSelector(PlayerSelectorType.PlayerAgent);
		public static readonly TargetPlayerSelector AllAgents = new TargetPlayerSelector(PlayerSelectorType.AllAgents);
