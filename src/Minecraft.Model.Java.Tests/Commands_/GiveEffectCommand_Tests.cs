...
namespace Minecraft.Model.Java.Tests
{
	...
	{
		[TestCase("@a", StatusEffect.NightVision, "/effect give @a night_vision")]
		...
		[TestCase("@a", StatusEffect.NightVision, 180, "/effect give @a night_vision 180")]
		...
		[TestCase("@a", StatusEffect.NightVision, 180, 0, "/effect give @a night_vision 180")]
		[TestCase("@a", StatusEffect.NightVision, 180, 3, "/effect give @a night_vision 180 3")]
		...
		[TestCase("@a", StatusEffect.NightVision, 180, 3, false, "/effect give @a night_vision 180 3")]
		[TestCase("@a", StatusEffect.NightVision, 180, 3, true, "/effect give @a night_vision 180 3 true")]
