...
namespace Minecraft.Construction.Java
{
	...
	{
		public static readonly Block OuterGlass = Block.Get(BlockID.StainedGlassPane.Gray);
		public static readonly Block InnerGlass = Block.Get(BlockID.StainedGlassPane.White);
