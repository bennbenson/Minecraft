...
namespace Minecraft.Construction.Java
{
	public static class WarpZone
	{
		public static IEnumerable<Command> Generate(WarpZoneParameters parameters, Block block)
		{
			...
			{
				southFacingCommandBlock = new CommandBlock(new Dictionary<string, string>() { { "facing", "south" } }, Command.Empty);
				northFacingCommandBlock = new CommandBlock(new Dictionary<string, string>() { { "facing", "north" } }, Command.Empty);
				westFacingCommandBlock = new CommandBlock(new Dictionary<string, string>() { { "facing", "west" } }, Command.Empty);
				eastFacingCommandBlock = new CommandBlock(new Dictionary<string, string>() { { "facing", "east" } }, Command.Empty);
			}
